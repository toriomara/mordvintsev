    ...
    <>
      {isOpen && (
        <div className='fixed inset-0 flex flex-col justify-center items-center bg-neutral-800 bg-opacity-80 z-10 backdrop-blur-sm'>
          <div
            className='relative w-full max-w-2xl h-60 m-4 border border-custom bg-background rounded-lg shadow-lg'
            id='modal'
          >
            <div className='relative flex gap-2 p-4 justify-end border-b border-custom'>
