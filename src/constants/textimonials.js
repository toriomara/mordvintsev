export const testimonials = [
  ...
  },
  {
    ...
    text: "Хочу выразить благодарность и сказать большое спасибо адвокату Роману Федоровичу Мордвинцеву. Это очень чуткий, честный, отзывчивый человек. А самое главное - профессионал своего дела. Роман Федорович очень помог нам.  Мой супруг мог получить большой срок наказания, но благодаря  опыту, профессионализму и  компетентности нашего адвоката Романа Федоровича, мы, можно сказать, отделались легким испугом. Роман Федорович очень хорошо относится к своим обязанностям адвоката, вникает во все подробности  и делает все возможное, что бы помочь своему клиенту. Он действует именно в интересах своего клиента. Очень рекомендую этого адвоката. Мы остались очень довольны его работой. Спасибо, Роман Федорович.",
    estimation: 5,
  },
  {
    id: 6,
