  ...
  return (
    <div className="wrapper-main flex gap-6 w-full">
      <div className="w-full">
        ...
        <div>
          <h3 className="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight pb-2">
            1. Общие положения
          </h3>
          <p className="mb-4 font-medium">
            ...
            Адвокатом Мордвинцевым Романом Фёдоровичем (далее — Оператор).
          </p>
          ...
          <p className="paragraph">
            ...
            https://amordvintsev.ru/politics.
          </p>
          <h3 className="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight pb-2">
          ...
          <p className="paragraph">
            ...
            Оператора info@amordvintsev.ru с пометкой «Актуализация персональных
            данных».
          </p>
          <p className="paragraph">
            ...
            info@amordvintsev.ru с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
          <p className="paragraph">
          ...
          <p className="paragraph">
            ...
            к Оператору с помощью электронной почты info@amordvintsev.ru.
          </p>
          <p className="paragraph">
          ...
          <p className="paragraph">
            ...
            сети Интернет по адресу httpsː//amordvintsev.ru/politics.
          </p>
        </div>
      </div>
    </div>
